...
namespace Capitulo06.HttpTestes
{
    [TestClass]
    public class HttpTeste
    {
        [TestMethod]
        public void RequestGetMethodTest()
        {
            var request = (HttpWebRequest)WebRequest.Create("http://www.example.com?nome=Kleber&cpf=123");
            request.Method = "GET";
        ...
        public void RequestPostMethodTeste()
        {
            ...
            var dados = "placa=BPA5911&modelo=Fusca&ano=1994";
        ...
        {
            var statusLine = $"HTTP/{response.ProtocolVersion} {(int)response.StatusCode} {response.StatusDescription}" + Environment.NewLine;
